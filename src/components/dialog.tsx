...
export function DialogOverley({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Overlay>) {
    ...
    return (
        <DialogPrimitive.Portal>
            ...
            <DialogPrimitive.Content ref={ref} className={cn(`
                ...
                data-[state=closed]:fade-out-0
                data-[state=closed]:slide-out-to-bottom-[48%]`, className)}
                {...props}>
...
export function DialogHeader({ children, className, ...props }: React.ComponentProps<"div">) {
    return (
        <>
            <header className={cn(`
            flex items-center justify-between`, className)}{...props}>
