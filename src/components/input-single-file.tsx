...
export const inputSingleFilesVariants = tv({
    base: `
...
interface InputSingleFileProps extends VariantProps<typeof inputSingleFilesVariants>,
...
export default function InputSingleFile({ form, size, error, allowedExtentions, maxFileSizeInMb, replaceBy, ...props }: InputSingleFileProps) {
    ...
    function isValidExtension() {
        return allowedExtentions.includes(fileExtension ?? "");
    }
            ...
            {!formFile || !isValidFile() ?
                (<>
                    <div className="w-full relative group cursor-pointer">
                        ...
                        <div className={inputSingleFilesVariants({ size })}>
                    ...
                    <div className="flex flex-col gap-1 mt-1">
                        ...
                        {formFile && !isValidSize() &&
                            <Text variant="label-small" className="text-accent-red">
                                O tamanho do arquivo ultrapassa o maximo de {maxFileSizeInMb}mb.
                            </Text>
                        }
                        {error && (
                            <Text variant="label-small" className="text-accent-red">
